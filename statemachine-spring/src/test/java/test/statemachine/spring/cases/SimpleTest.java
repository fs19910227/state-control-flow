...
public class SimpleTest extends BaseTest {
	...
	//	StateMachine<States, Events, TestOrderInfo> id = selectByContent(orderInfo());
	//	String s = umlString(id);
	//	SourceStringReader reader = new SourceStringReader(s);
	//	reader.generateImage(new File(umlPath,"test.png"));
	//
	//
	//}
